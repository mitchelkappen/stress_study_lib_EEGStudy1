...
data <-
  as.data.frame(read.csv(file = paste0(FEATURES_PATH, 'dataComplete.csv')))

dataSmall <- data[(data$fileNum == 2|data$fileNum == 3|data$fileNum == 4|data$fileNum == 6|data$fileNum == 7|data$fileNum == 8), ]
...
dataSmall$condition[dataSmall$fileNum == 2|dataSmall$fileNum == 3|dataSmall$fileNum == 4] = 0
dataSmall$condition[dataSmall$fileNum == 6|dataSmall$fileNum == 7|dataSmall$fileNum == 8] = 1
